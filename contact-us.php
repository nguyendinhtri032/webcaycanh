	    		...
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Liên hệ với chúng tôi</h2>    			    				    				
					 <div id="gmap" class="contact-map">
	 					<img src="./images/contact-us/contact-us-icon.jpg" width="100%";
					</div> 
				</div>			 		
			</div>    	
    		<div class="row">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>WEBCAYCANH</p>
							<p>Văn Phòng: 273 An Dương Vương F3, Q5, TP. Hồ Chí Minh</p>
							<p>Mobile: 035.123.6789</p>
							<p>Email: info@WEBCAYCANH.com</p>
	    				</address>
